...
- **Create a piece** : You can create a new piece you recently developed and add it to your pieces list.
- **Create versions** : You can add new versions with descriptions to your existing pieces and trace their date of creation.
...
- Add the possibility to delete pieces and versions
